if status is-interactive
    ...
    set -x -g PATH /Users/dgedon/.local/share/gem/ruby/3.4.0/bin $PATH
    set -x -g PATH /opt/homebrew/lib/ruby/gems/3.4.0/bin $PATH
    set -x -g PATH ~/.cargo/bin $PATH
    set -x -g PATH ~/bin ~/.local/bin $PATH
    set -x -g BAT_THEME Dracula
    set -x -g GSETTINGS_SCHEMA_DIR /opt/homebrew/share/glib-2.0/schemas/
